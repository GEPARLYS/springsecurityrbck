		...
		<div class="content-wrapper">
			...
			<div class="box box-primary">
				...
				<div class="box-body">
					...
					<div class="table-box">
							...
							<div class="form-group form-inline">
								<div class="btn-group">
									<button type="button" class="btn btn-default" title="新建"
										onclick='location.href="${pageContext.request.contextPath}/product/initAdd"'>
								...
								<tr>
									...
									<td class="text-center">
										<button type="button" class="btn bg-olive btn-xs"
											onclick='location.href="${pageContext.request.contextPath}/product/initUpdate?id=${product.id}"'>修改</button>
										<button type="button" class="btn bg-olive btn-xs"
                        ...
                        <script type="text/javascript">
                            function del(id) {
                                if(confirm("确认要删除此记录吗？一旦删除将无法恢复!")){
                                    // 用户点击了确定
				...
				<div class="box-footer">
					<div class="pull-left">
						<div class="form-group form-inline">
							当前第${pageInfo.pageCode}页/总共${pageInfo.totalPage}页，共${pageInfo.totalCount}条数据。 每页
					...
					<script type="text/javascript">
						function submitPageSize(option) {
						    // 再次查询
							location.href='/product/pageList?page=1&size=' + option.value;
                        }
					</script>

					<div class="box-tools pull-right">
						<ul class="pagination">
							<li><a href="/product/pageList?page=1&size=${pageInfo.pageSize}" aria-label="Previous">首页</a></li>
							<li><a href="/product/pageList?page=${pageInfo.pageCode-1}&size=${pageInfo.pageSize}">上一页</a></li>
							<c:forEach begin="1" end="${pageInfo.totalPage}" var="i">
								<c:if test="${i < 6}">
							<li><a href="/product/pageList?page=${i}&size=${pageInfo.pageSize}">${i}</a></li>
								</c:if>
								<c:if test="${i == 6}">
									<li><a >...</a></li>
								</c:if>
							</c:forEach>
							<li><a href="/product/pageList?page=${pageInfo.pageCode+1}&size=${pageInfo.pageSize}">下一页</a></li>
							<li><a href="/product/pageList?page=${pageInfo.totalPage}&size=${pageInfo.pageSize}" aria-label="Next">尾页</a></li>
						</ul>
					</div>
